...
export default function Home() {
  ...
  const { connectAsync, connectors, isPending: isConnecting, error: walletError } = useConnect();
  ...
  const handleConnect = async () => {
    ...
    if (connector) {
      ...
      setCustomError("No wallet connector found. Please install MetaMask.");
    }
  };

  // Display error from either wallet connection or auth verification
  const displayError = customError || walletError?.message || authError;
