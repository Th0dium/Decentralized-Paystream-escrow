    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 p-4">
      ...
      <div className="relative max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Decentralized Salary Streaming & Escrow</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-500">Connect with MetaMask to access the platform</p>
          </div>
          ...
          {isConnected && !isAuthenticated && (
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Verifying Wallet</h3>
          ...
          {!isConnected && (
            <div className="space-y-4">
              <button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-between p-4 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white rounded-xl transition-all duration-200 shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed group"
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-xs text-orange-100">Most popular wallet</div>
                  </div>
                </div>
                {isLoading ? (
              ...
              {walletError && !isConnected && connectors.length === 0 && (
                <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
                  <div className="text-center">
                    ...
                    <h3 className="font-medium text-gray-900 mb-2">No Wallet Detected</h3>
                    <p className="text-sm text-gray-600 mb-4">Install MetaMask to connect to the platform</p>
                    <a
